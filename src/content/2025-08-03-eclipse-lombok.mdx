...
![lombok.jar 파일 다운로드](/mdx-blog/images/back-end/eclipse-lombok/pic1.avif)
...
![lombok.jar 파일 실행하기](/mdx-blog/images/back-end/eclipse-lombok/pic2.avif)

파일을 실행하면 `Lombok`을 설치할 수 있습니다.

![Lombok 설치하기](/mdx-blog/images/back-end/eclipse-lombok/pic3.avif)

### 3.3. Step 3 - Lombok 적용하기

`Lombok` 설치 이후에는 `Eclipse IDE`에서 `Project > Clean`을 클릭하면 `Lombok`을 적용할 수 있습니다.

![Lombok 적용하기](/mdx-blog/images/back-end/eclipse-lombok/pic4.avif)
