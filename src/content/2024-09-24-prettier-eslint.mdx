...
![Prettier - Code formatter](/mdx-blog/images/front-end/prettier-eslint/pic1.avif)

![ESLint](/mdx-blog/images/front-end/prettier-eslint/pic2.avif)
...
![Editor: Format On Save](/mdx-blog/images/front-end/prettier-eslint/pic3.avif)

![Editor: Format On Save](/mdx-blog/images/front-end/prettier-eslint/pic4.avif)

<br />

이후 `Default Formatter`를 `Prettier - Code formatter`로 변경합니다.

![Default Formatter 변경](/mdx-blog/images/front-end/prettier-eslint/pic5.avif)

<br />

마지막으로 `settings.json` 파일을 확인하여 `"editor.formatOnSave": true`로 설정되어 있는지 확인합니다.

![settings.json 파일](/mdx-blog/images/front-end/prettier-eslint/pic6.avif)

!["editor.formatOnSave": true](/mdx-blog/images/front-end/prettier-eslint/pic7.avif)
