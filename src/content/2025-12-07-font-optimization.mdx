...
![TTF/OTF](/mdx-blog/images/front-end/font-optimization/pic1.avif)

![WOFF](/mdx-blog/images/front-end/font-optimization/pic2.avif)

![WOFF2](/mdx-blog/images/front-end/font-optimization/pic3.avif)

![폰트 포맷들의 용량 비교](/mdx-blog/images/front-end/font-optimization/pic4.avif)
...
![원본 폰트 파일 크기: 766 KB](/mdx-blog/images/front-end/font-optimization/pic5.avif)
...
![Transfonter](/mdx-blog/images/front-end/font-optimization/pic6.avif)

변환하고자 하는 원본 폰트 파일을 선택한 후, Characters에 폰트를 적용할 문자(Ex. "서브셋 폰트")를 넣은 후 Convert 버튼을 누르면 서브셋 폰트를 생성할 수 있습니다.

![Transfonter](/mdx-blog/images/front-end/font-optimization/pic7.avif)

실제로 서브셋 폰트를 사용하였을 때 파일 용량이 크게 줄어든 것을 확인할 수 있습니다.

![서브셋 폰트 파일 크기: 2.1 KB](/mdx-blog/images/front-end/font-optimization/pic8.avif)
