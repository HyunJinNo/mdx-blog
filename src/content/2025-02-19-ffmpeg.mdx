export const metadata = {
  ...
  pin: false,
  imagePath: "/mdx-blog/images/etc/ffmpeg/ffmpeg-logo.webp",
};
...
![Download FFmpeg](/mdx-blog/images/etc/ffmpeg/pic1.avif)

![Download FFmpeg](/mdx-blog/images/etc/ffmpeg/pic2.avif)

#### 4.1.2. 환경 변수 등록하기

다음과 같이 원하는 디렉토리에 압축 파일을 풀고 `bin` 폴더의 주소를 복사합니다. 저는 `로컬 디스크(C:)`를 선택했습니다.

![로컬 디스크(C:)](/mdx-blog/images/etc/ffmpeg/pic3.avif)

이후 `시스템 환경 변수 편집`에 들어가서 다음과 같이 방금 복사한 `bin` 폴더의 주소를 환경 변수에 등록합니다.

![환경 변수 등록](/mdx-blog/images/etc/ffmpeg/pic4.avif)
...
![Windows에서 버전 확인 결과](/mdx-blog/images/etc/ffmpeg/pic5.avif)

![macOS에서 버전 확인 결과](/mdx-blog/images/etc/ffmpeg/pic20.avif)
...
![파일 정보 확인](/mdx-blog/images/etc/ffmpeg/pic8.avif)
...
![파일 정보 확인](/mdx-blog/images/etc/ffmpeg/pic7.avif)
...
![이미지 포맷 변환](/mdx-blog/images/etc/ffmpeg/pic6.avif)
...
![비디오 특정 구간 자르기](/mdx-blog/images/etc/ffmpeg/pic9.avif)
...
![비디오 특정 구간 자르기](/mdx-blog/images/etc/ffmpeg/pic10.avif)
...
![해상도 변경](/mdx-blog/images/etc/ffmpeg/pic11.avif)
...
![해상도 변경](/mdx-blog/images/etc/ffmpeg/pic13.avif)
...
![gif 생성 1](/mdx-blog/images/etc/ffmpeg/pic12.avif)
...
![WebM을 Animated WebP로 만들기](/mdx-blog/images/etc/ffmpeg/pic18.avif)
...
![비디오에서 오디오 추출](/mdx-blog/images/etc/ffmpeg/pic14.avif)
...
![비디오에서 이미지를 추출한 결과](/mdx-blog/images/etc/ffmpeg/pic19.avif)
...
![여러 개의 비디오 병합](/mdx-blog/images/etc/ffmpeg/pic15.avif)
...
![여러 개의 오디오 병합](/mdx-blog/images/etc/ffmpeg/pic17.avif)
...
![FFmpeg으로 Windows 화면 녹화](/mdx-blog/images/etc/ffmpeg/pic16.avif)
