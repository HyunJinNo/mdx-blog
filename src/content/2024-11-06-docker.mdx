export const metadata = {
  ...
  pin: false,
  imagePath: "/mdx-blog/images/raspberry-pi/docker/docker.webp",
};
...
![Docker 버전 확인](/mdx-blog/images/raspberry-pi/docker/pic1.avif)

![Docker 상태 확인](/mdx-blog/images/raspberry-pi/docker/pic2.avif)
...
![Docker 그룹 확인](/mdx-blog/images/raspberry-pi/docker/pic3.avif)
...
![이미지 검색](/mdx-blog/images/raspberry-pi/docker/pic4.avif)
...
![이미지 태그 지정](/mdx-blog/images/raspberry-pi/docker/pic7.avif)
...
![이미지 업로드](/mdx-blog/images/raspberry-pi/docker/pic6.avif)
...
![이미지 목록 확인](/mdx-blog/images/raspberry-pi/docker/pic5.avif)
...
![-it 옵션을 사용하지 않는 경우](/mdx-blog/images/raspberry-pi/docker/pic8.avif)

반면에 `-it` 옵션을 사용하는 경우 컨테이너 내부의 Bash Shell로 들어가 직접 명령어를 실행할 수 있습니다.

![-it 옵션을 사용하는 경우](/mdx-blog/images/raspberry-pi/docker/pic9.avif)
