...
![Nginx 설치](/mdx-blog/images/raspberry-pi/nginx/pic1.avif)
...
![Nginx 설치 확인](/mdx-blog/images/raspberry-pi/nginx/pic2.avif)
...
![Nginx 디렉토리 구조 확인](/mdx-blog/images/raspberry-pi/nginx/pic3.avif)
...
![리버스 프록시 서버 블록 설정](/mdx-blog/images/raspberry-pi/nginx/pic4.avif)
...
![nginx.conf 파일](/mdx-blog/images/raspberry-pi/nginx/pic5.avif)
...
![활성화한 사이트 설정 파일 가져오기](/mdx-blog/images/raspberry-pi/nginx/pic6.avif)
...
![설정 파일에 대한 문법 검사](/mdx-blog/images/raspberry-pi/nginx/pic7.avif)
...
![Nginx 설정 완료](/mdx-blog/images/raspberry-pi/nginx/pic8.avif)
...
![pm2로 서비스 실행](/mdx-blog/images/raspberry-pi/nginx/pic9.avif)

서비스가 실행되면 웹 사이트에 접속합니다.

![80번 포트 사용](/mdx-blog/images/raspberry-pi/nginx/pic10.avif)
