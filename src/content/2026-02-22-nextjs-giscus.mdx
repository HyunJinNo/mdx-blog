...
![Settings 탭](/mdx-blog/images/front-end/nextjs-giscus/pic1.avif)

![General](/mdx-blog/images/front-end/nextjs-giscus/pic2.avif)

![Discussions 활성화](/mdx-blog/images/front-end/nextjs-giscus/pic3.avif)

![Discussions 기능](/mdx-blog/images/front-end/nextjs-giscus/pic4.avif)

### 2.2. Step 2 - Giscus 앱 설치하기

[GitHub Apps - giscus](https://github.com/apps/giscus)에 접속하여 Giscus 앱을 설치한 후, 해당 저장소에 권한을 부여합니다.

![Giscus 앱 설치](/mdx-blog/images/front-end/nextjs-giscus/pic5.avif)

![Giscus 앱 설치](/mdx-blog/images/front-end/nextjs-giscus/pic6.avif)

![권한 부여하기](/mdx-blog/images/front-end/nextjs-giscus/pic7.avif)

![권한 부여 완료](/mdx-blog/images/front-end/nextjs-giscus/pic8.avif)
...
![저장소 설정](/mdx-blog/images/front-end/nextjs-giscus/pic9.avif)

#### 2.3.2. 페이지 ↔️ Discussions 연결

페이지와 Discussion을 연결할 방법을 선택합니다. 저는 `pathname` 방식을 선택하였습니다.

![페이지 ↔️ Discussions 연결](/mdx-blog/images/front-end/nextjs-giscus/pic10.avif)

#### 2.3.3. Discussion 카테고리

새 Discussion이 만들어질 카테고리를 설정합니다. 저는 Giscus에서 권장하는 `Announcements` 카테고리를 선택하였습니다.

![Discussion 카테고리](/mdx-blog/images/front-end/nextjs-giscus/pic11.avif)

#### 2.3.4. 기능

추가 기능을 선택합니다. 저의 경우 초기 로딩 속도를 고려하여 지연 로딩 기능을 추가하였습니다.

![기능](/mdx-blog/images/front-end/nextjs-giscus/pic12.avif)

#### 2.3.5. 테마

마지막으로 원하는 Giscus 테마를 선택합니다.

![테마](/mdx-blog/images/front-end/nextjs-giscus/pic13.avif)
...
![Giscus 사용 예시](/mdx-blog/images/front-end/nextjs-giscus/pic14.avif)

![Giscus 사용 예시](/mdx-blog/images/front-end/nextjs-giscus/pic15.avif)
