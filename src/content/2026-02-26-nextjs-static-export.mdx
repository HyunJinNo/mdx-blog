...
이번 글에서는 GitHub Pages에 배포하기 `GitHub Actions`를 활용합니다.
...
![generateStaticParams 설정 이전](/mdx-blog/images/front-end/nextjs-static-export/pic1.avif)
...
![generateStaticParams 설정 이후](/mdx-blog/images/front-end/nextjs-static-export/pic2.avif)
...
![Settings > Pages](/mdx-blog/images/front-end/nextjs-static-export/pic3.avif)

![GitHub Actions](/mdx-blog/images/front-end/nextjs-static-export/pic4.avif)
...
>
> ![basePath 미설정 시 발생하는 오류](/mdx-blog/images/front-end/nextjs-static-export/pic5.avif)
...
![workflow 이름](/mdx-blog/images/front-end/nextjs-static-export/pic6.avif)
...
![GitHub Pages 정적 배포 결과](/mdx-blog/images/front-end/nextjs-static-export/pic7.avif)

## 8. 참고 자료

- [Release: GitHub Pages 정적 배포 by HyunJinNo · Pull Request #27 · HyunJinNo/mdx-blog](https://github.com/HyunJinNo/mdx-blog/pull/27)
