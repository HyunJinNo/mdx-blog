...
![babel.config.js 설정](/mdx-blog/images/front-end/react-native-path-alias/pic1.avif)
...
![assets 폴더 예시](/mdx-blog/images/front-end/react-native-path-alias/pic2.avif)
