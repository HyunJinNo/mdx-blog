export const metadata = {
  ...
  tags: ["git", "github"],
  pin: false,
  imagePath: "/mdx-blog/images/etc/github-template/github-log.avif",
};
...
![GitHub Label](/mdx-blog/images/etc/github-template/pic2.avif)
...
![pull_request_template.md](/mdx-blog/images/etc/github-template/pic1.avif)
...
![PR 예시 1](/mdx-blog/images/etc/github-template/pic3.avif)

![PR 예시 2](/mdx-blog/images/etc/github-template/pic13.avif)

![PR 예시 3](/mdx-blog/images/etc/github-template/pic14.avif)
...
![Setting](/mdx-blog/images/etc/github-template/pic4.avif)

이후 `Features` 항목에서 `Issues` 부분의 `Set up templates` 버튼을 클릭합니다.

![Set up templates](/mdx-blog/images/etc/github-template/pic5.avif)

`Add template: select` 버튼을 클릭하여 생성하고자 하는 Issue Template을 선택하면 됩니다.

![Issue Template](/mdx-blog/images/etc/github-template/pic6.avif)

#### 4.1.1. Bug Report 생성하기

다음은 `Bug Report`를 생성한 예시입니다. 코드는 [아래](#421-bug-report-생성하기)에서 확인하실 수 있습니다.

![Bug Report 예시 1](/mdx-blog/images/etc/github-template/pic8.avif)

![Bug Report 예시 2](/mdx-blog/images/etc/github-template/pic7.avif)

#### 4.1.2. Feature Request 생성하기

다음은 `Feature Request`를 생성한 예시입니다. 코드는 [아래](#422-feature-request-생성하기)에서 확인하실 수 있습니다.

![Feature Request 예시 1](/mdx-blog/images/etc/github-template/pic9.avif)

![Feature Request 예시 2](/mdx-blog/images/etc/github-template/pic10.avif)
...
![VSCode에서 생성하기](/mdx-blog/images/etc/github-template/pic11.avif)
...
![Issue Template 생성 결과](/mdx-blog/images/etc/github-template/pic12.avif)
