...
![타입스크립트 버전 확인](/mdx-blog/images/cs/typescript/pic1.avif)

타입스크립트를 실행할 폴더에서 tsconfig.json 파일을 생성합니다. `npx tsc --init` 명령어를 통해 tsconfig.json 파일을 초기화하여 생성할 수 있습니다.

![tsconfig.json](/mdx-blog/images/cs/typescript/pic2.avif)
...
![컴파일 결과](/mdx-blog/images/cs/typescript/pic3.avif)
...
![컴파일 결과](/mdx-blog/images/cs/typescript/pic4.avif)
...
![ts-node](/mdx-blog/images/cs/typescript/pic5.avif)
