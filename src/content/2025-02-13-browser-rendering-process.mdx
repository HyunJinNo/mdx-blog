...
![네트워크 요청 및 리소스 로드](/mdx-blog/images/front-end/browser-rendering-process/pic1.avif)

![네트워크 요청 및 리소스 로드](/mdx-blog/images/front-end/browser-rendering-process/pic2.avif)
