...
![이미지 지연 로딩 (loading='lazy')](/mdx-blog/images/front-end/image-lazy-loading/pic1.webp)
...
![이미지 지연 로딩 (Intersection Observer)](/mdx-blog/images/front-end/image-lazy-loading/pic2.webp)
