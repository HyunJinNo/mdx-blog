export const metadata = {
  ...
  category: "Front-end",
  tags: ["monorepo", "nextra", "nextjs", "pnpm", "react", "tsdown"],
  pin: false,
...
총 5개의 Part로 분리하여 작성하였으며, 이 페이지에서는 **Next.js demo 생성 과정**을 다룹니다.
...
![demo 생성하기](/images/front-end/pnpm-tsdown-react-library-part-3/pic1.avif)
...
![페이지 목록](/images/front-end/pnpm-tsdown-react-library-part-3/pic2.avif)
...
![라이브러리 사용 예시](/images/front-end/pnpm-tsdown-react-library-part-3/pic3.avif)
